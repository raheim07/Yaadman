...
require(["vs/editor/editor.main"], function () {
  ...
  monaco.languages.setMonarchTokensProvider("yaadman", {
    keywords: ["Start", "Done", "Mek", "Set", "To", "Show", "Tek",
               "if", "Else", "While", "For", "Function", "Return","Try","Ketch","Number","Text","True","False"],
    tokenizer: {
      root: [
        [/\/\/.*$/,                          "comment"],
        [/"[^"]*"/,                           "string"],
        [/'[^']*'/,                           "string"],
        [/\b\d+(\.\d+)?\b/,                  "number"],
        [/\b(Start|Done|Mek|Set|To|Show|Tek|if|Else|While|For|Function|Return|Try|Ketch|Number|Text|True|False)\b/, "keyword"],
  ...
  document.getElementById("analyzeBtn").addEventListener("click", () => analyzeTokens(editor));
